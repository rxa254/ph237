...
\begin{figure}[t]
\includegraphics[width =1\columnwidth]{Figures/FPdiagup}
\caption{
}
\label{fig:FP}
\end{figure}
...
\begin{figure}[t]
\includegraphics[width =1\columnwidth]{Figures/FPgraphup}
\caption{
}
\label{fig:FPgraph}
\end{figure}
...
\begin{figure}[t]
\includegraphics[width =1\columnwidth]{Figures/Driven}
\caption{
}
\label{fig:Driven}
\end{figure}
...
\begin{figure}[h]
\includegraphics[width =.9\columnwidth]{Figures/2bclose}
\\
\includegraphics[width =.9\columnwidth]{Figures/2bwide}
...
\begin{figure}[t]
\includegraphics[width =1\columnwidth]{Figures/Michelsonup}
...
\begin{figure}[t]
\includegraphics[width =1\columnwidth]{Figures/Michelsongraph}
\caption{The transfer function $\Delta /x_0$ as a function of mirror modulation frequency $\omega$ for the Fabry-Perot Cavity.
}
...
\begin{figure}[h]
\includegraphics[width =.9\columnwidth]{Figures/2cclose}
\\
\includegraphics[width =.9\columnwidth]{Figures/2cwide}
